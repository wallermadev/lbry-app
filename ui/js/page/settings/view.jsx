...
class SettingsPage extends React.PureComponent {
  ...
  onApiSecretChanged(event) {
    this.setClientSetting("api_secret", event.target.value);
  }
        ...
        <section className="card">
          ...
          <div className="card__content">
            <FormRow
              ...
              helper={__(
                "Enter a different host or IP address here if you are running the daemon remotely. Changing this requires a restart."
              )}
            ...
            <FormRow
              ...
              helper={__(
                "Enter the API secret generated by the daemon if you have turned on HTTP authentication."
              )}
              onChange={this.onApiSecretChanged.bind(this)}
            />
          </div>
        </section>
